...
for i in range(0,3):
  LayerDense1 = keras.layers.Dense(125, activation=None, use_bias=True, kernel_initializer='glorot_uniform')
...
genderModel.fit(BazaImg, BazaAns, epochs=20, batch_size=5, shuffle=True)
